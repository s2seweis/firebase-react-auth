  ...
  return (
    <section>
      <nav>
        ...
        <div style={{textAlign: "center", fontSize:"xx-large", background:"lightblue"}}>
        <p>
          LoginSuccess 
        </p>
        </div>

        <div style={{background:"lightblue", width:"200px", fontSize:"larger", marginLeft:"20px", height:"auto"}}>


        <div style={{display:"grid", marginLeft:"20px", padding:"20px"}}>
            <p>Routes:</p>
